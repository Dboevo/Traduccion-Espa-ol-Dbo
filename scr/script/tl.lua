...
DST_TUTORIAL_MESSAGE_1000035	=	1000035	-- 아이템 줍기 - 몹을 한마리 더 사냥하고 떨어지는 캡슐을클릭해서 집어보세요                                     
...
DST_TUTORIAL_MESSAGE_1000046	=	1000046	-- 도움말 열기 - 단축키 'F1'을 누르거나 메인메뉴의 도움말 메뉴로도움말을 열 수 있습니다                         
...
TLKeyboardInputLock(ETL_KEYBOARD_INPUT_TYPE_SCOUTER_MODE);              --막기 : 
